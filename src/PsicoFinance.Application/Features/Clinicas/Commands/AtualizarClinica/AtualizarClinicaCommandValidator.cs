...
public class AtualizarClinicaCommandValidator : AbstractValidator<AtualizarClinicaCommand>
{
    public AtualizarClinicaCommandValidator()
    {
        RuleFor(x => x.Nome)
        ...
        RuleFor(x => x.Timezone)
            .NotEmpty().WithMessage("Timezone é obrigatório.")
            .MaximumLength(50).WithMessage("Timezone deve ter no máximo 50 caracteres.");
    }
}
